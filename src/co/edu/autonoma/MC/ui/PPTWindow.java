 ...
 */
public class PPTWindow extends javax.swing.JFrame implements PPTGame{
     ...
     */
    public PPTWindow(Cliente cliente) {
        initComponents();
    ...
    private void btnTerminarPartidaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTerminarPartidaActionPerformed
        ...
        if(opcion==JOptionPane.YES_OPTION){
            this.cliente.enviarMensajeTerminarPartida();
        }      
